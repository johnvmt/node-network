...
module.exports=require("./lib/NodeRouter");
},{"./lib/NodeRouter":3}],2:[function(require,module,exports){
function AddressManager(r){if(!Array.isArray(r.baseAddress))throw new Error("base_address_not_set");this._baseAddress=r.baseAddress,this._max="0",this._stringBase=36}AddressManager.prototype.allocate=function(){return this._max=this._incrementString(this._max,this._stringBase,1),this._baseAddress.concat(this._max)},AddressManager.prototype.addressIsEqual=function(r,s){if(Array.isArray(s)||(s=this._baseAddress),r.length==s.length){var e;for(e=0;e<s.length;e++)if(r[e]!=s[e])return!1;return!0}return!1},AddressManager.prototype.addressIsChild=function(r,s){if(Array.isArray(s)||(s=this._baseAddress),r.length>s.length){var e;for(e=0;e<s.length;e++)if(r[e]!=s[e])return!1;return!0}return!1},AddressManager.prototype.addressIsParent=function(r,s){return Array.isArray(s)||(s=this._baseAddress),this.addressIsChild(s,r)},AddressManager.prototype._incrementString=function(r,s,e){return(parseInt(r,s)+e).toString(s)},module.exports=function(r){return new AddressManager(r)};
},{}],3:[function(require,module,exports){
(function (process){
function NodeRouter(e){"object"!=typeof e&&(e={});var t=this;t.config=e,t._routeTable=RouteTable(),t._connections={},t._connectionKeyMax=-1,t._rpc=Rpc(),process.nextTick(function(){t.setAddress(t.config.address)}),t._actions={ping:function(e,t,o){o(null,!0)},route:function(e,o,r){t._route(e,r)},addressrevoke:function(e,o,r){"undefined"!=typeof t._addressManager&&t._addressManager.addressIsEqual(e)&&t._setAddressParts()},addressrequest:function(e,o,r){if("object"==typeof t._addressManager){var n=t._addressManager.allocate();r(null,n)}else r("no_address",null)},routesupdate:function(e,o){if(t._routesApplyOperations(e,o),"undefined"==typeof t.address){var r=function(e){return 0==e.cost},n=t._routeOperationsFilter(e,{insert:r});Array.isArray(n.insert)&&n.insert.length>0&&t.rpcRequest(o,"addressrequest",function(e,o){e?console.error("ADDREQ-FAILED",e):t._setAddressParts(o)})}}}}var Rpc=require("agnostic-rpc"),EventEmitter=require("wolfy87-eventemitter"),RouteTable=require("./RouteTable"),AddressManager=require("./AddressManager"),Utils=require("./Utils");NodeRouter.prototype.__proto__=EventEmitter.prototype,NodeRouter.prototype.send=function(){var e=Utils.parseArgs(arguments,[{name:"destAddressJoined",level:0,validate:function(e,t){return"string"==typeof e}},{name:"message",level:0},{name:"options",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=e.destAddressJoined.split("-");this._route({message:e.message,dest:t},e.callback)},NodeRouter.prototype.setAddress=function(e){if("string"==typeof e){var t=e.split("-");return this._setAddressParts(t)}return!1},NodeRouter.prototype._broadcastRouteOperations=function(e){var t=this;Utils.objectForEach(t._connections,function(o,r){t.rpcRequest(r,"routesupdate",e)})},NodeRouter.prototype._routesApplyOperations=function(e,t){var o=this,r=JSON.parse(JSON.stringify(e)),n=function(e){return"undefined"==typeof o._addressManager||!o._addressManager.addressIsEqual(e.address)},s=o._routeOperationsFilter(r,{insert:n});Array.isArray(s.insert)&&s.insert.forEach(function(e){e.cost=e.cost+1});var a=o._routeTable.modifyRoutes(s,t),n=function(e){return"undefined"!=typeof o._addressManager&&!o._addressManager.addressIsChild(e.address)};localOperationsBroadcast=o._routeOperationsFilter(a,{insert:n}),Object.keys(localOperationsBroadcast).length&&o._broadcastRouteOperations(localOperationsBroadcast)},NodeRouter.prototype._setAddressParts=function(e){var t=this,o={};if("undefined"!=typeof t.address){o.remove=[t.address];var r=t._routeTable.childRoutes(this.address);"object"==typeof r&&Utils.objectForEach(r,function(e,o){var r=t.address.concat(o);t._routeTable.removeRoute(r,e.connectionKey),t.rpcRequest(e.connectionKey,"addressrevoke",r)})}t.address=e,t._addressManager=void 0,"undefined"!=typeof t.address&&(t._addressManager=AddressManager({baseAddress:t.address}),o.insert=[{address:t.address,cost:0}]),Object.keys(o).length&&t._broadcastRouteOperations(o),t.emit("addressParts",t.address);var n=Array.isArray(this.address)?t.address.join("-"):void 0;t.emit("address",n)},NodeRouter.prototype.connectionRouteTableOperations=function(e){var t=this,o=function(o,r){return o.connection!=e&&("object"!=typeof t._addressManager||!t._addressManager.addressIsChild(r))},r=t._routeTable.toRouteOperations(o);return"undefined"!=typeof t.address&&(Array.isArray(r.insert)||(r.insert=[]),r.insert.push({address:t.address,cost:0})),r},NodeRouter.prototype.addConnection=function(e,t){function o(){var t=r.connectionRouteTableOperations(e);r.rpcRequest(n,"routesupdate",t)}var r=this;r._connectionKeyMax++;var n=r._connectionKeyMax;"object"==typeof t&&null!=t||(t={}),r._connections[n]={connection:e,options:t},e.on("data",function(e){try{r._rpcMessage(n,e)}catch(e){console.error(e)}}),e.on("disconnect",function(){var e=r._routeTable.removeConnectionRoutes(n);r._broadcastRouteOperations(e),delete r._connections[n]}),e.on("connect",function(){r._connections[n]={connection:e,options:t},o()}),o()},NodeRouter.prototype._routeOperationsFilter=function(e,t){var o={};return Utils.objectForEach(e,function(e,r){if(Array.isArray(e))if("function"==typeof t[r]){var n=e.filter(t[r]);Array.isArray(n)&&n.length>0&&(o[r]=n)}else o[r]=e}),o},NodeRouter.prototype.rpcBroadcast=function(){var e=this,t=Array.prototype.slice.call(arguments);Utils.objectForEach(e._connections,function(o,r){e.rpcRequest.apply(e,[r].concat(t))})},NodeRouter.prototype.rpcRequest=function(){var e=Utils.parseArgs(arguments,[{name:"connectionKey",level:0},{name:"action",level:0,validate:function(e,t){return"string"==typeof e}},{name:"query",level:1,validate:function(e,t){return"object"==typeof e},default:{}},{name:"callback",level:1,validate:function(e,t){return"function"==typeof e}}]),t=this._rpc.request({action:e.action,query:e.query},function(t,o){"function"==typeof e.callback&&(t?e.callback(t,null):"string"==typeof o.status&&"ok"==o.status?e.callback(null,o.response):"string"==typeof o.status&&e.callback(o.error,o.response))}),o=this._connections[e.connectionKey].connection;o.emit("data",t)},NodeRouter.prototype._route=function(e,t){if("object"==typeof this._addressManager&&this._addressManager.addressIsEqual(e.dest))this.emit("data",e),this.emit("message",e.message),"function"==typeof t&&t(null,this.address);else{var o=this._routeTable.nextConnection(e.dest);"undefined"!=typeof o?this.rpcRequest(o,"route",e,t):"function"==typeof t&&t("no_route",null)}},NodeRouter.prototype._rpcMessage=function(e,t){var o=this;if(o._rpc.messageIsResponse(t))o._rpc.handleResponse(t);else{var r=o._actions;o._rpc.handleRequest(t,function(t,o){var n=function(e,t){o(e?{status:"error",error:e,response:t}:{status:"ok",response:t})};"string"==typeof t.action&&"function"==typeof r[t.action]?r[t.action](t.query,e,n):n("action_not_found",null)},function(t){var r=o._connections[e].connection;r.emit("data",t)})}},module.exports=function(e){return new NodeRouter(e)};
}).call(this,require('_process'))

},{"./AddressManager":2,"./RouteTable":4,"./Utils":6,"_process":9,"agnostic-rpc":7,"wolfy87-eventemitter":10}],4:[function(require,module,exports){
function RouteTable(e){this.table=Tree()}var Utils=require("./Utils"),Tree=require("./Trie");RouteTable.prototype.toRouteOperations=function(e){var t=[];return this.table.traverse(function(r,o){("function"!=typeof e||e(r,o))&&t.push({address:o,cost:r.cost})}),0==t.length?{}:{insert:t}},RouteTable.prototype.childRoutes=function(e){return this.table.children(e)},RouteTable.prototype.nextConnection=function(e){var t=this.table.deepest(e);return"object"==typeof t?t.data.connectionKey:void 0},RouteTable.prototype.removeConnectionRoutes=function(e){var t=[];return this.table.traverse(function(r,o){r.connectionKey==e&&t.push(o)}),this.modifyRoutes({remove:t},e)},RouteTable.prototype.modifyRoutes=function(e,t){var r=this,o={};return Array.isArray(e.remove)&&e.remove.forEach(function(e){Array.isArray(e)&&r.removeRoute(e,t)&&(Array.isArray(o.remove)||(o.remove=[]),o.remove.indexOf(e)<0&&o.remove.push(e))}),Array.isArray(e.insert)&&e.insert.forEach(function(e){Array.isArray(e.address)&&"number"==typeof e.cost&&r.insertRoute(e.address,t,e.cost)&&(Array.isArray(o.insert)||(o.insert=[]),o.insert.indexOf(e)<0&&o.insert.push(e))}),o},RouteTable.prototype.insertRoute=function(e,t,r){var o=this.table.get(e);return("undefined"==typeof o||o.cost>r||o.connectionKey==t)&&(this.table.set(e,{cost:r,connectionKey:t}),!0)},RouteTable.prototype.removeRoute=function(e,t){var r=this.table.get(e);return"object"==typeof r&&r.connectionKey==t&&this.table.remove(e)},module.exports=function(e){return new RouteTable(e)};
},{"./Trie":5,"./Utils":6}],5:[function(require,module,exports){
